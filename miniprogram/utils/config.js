...
const FORM_CONFIG = {
  personnel: {
    ...
    fields: [
      ...
      { key: 'type', label: '类型', picker: ['消防队员', '水务抢险队', '应急救援队', '民兵预备役', '志愿者', '巡查人员', '值班人员', '医疗救护', '其他'] },
      { key: 'team', label: '队伍', picker: ['消防救援大队', '水务抢险队', '区应急救援队', '街道应急分队', '民兵应急连', '志愿救援队', '蓝天救援队', '红十字会', '其他'] },
      ...
      { key: 'region_name', label: '所属区域', placeholder: '如: 黄埔区红山街道' },
    ],
  },
  materials: {
    title: '物资装备',
    fields: [
      ...
      { key: 'category', label: '类别', picker: ['排水设备', '发电照明', '防护用品', '救生器材', '通信设备', '帐篷棉被', '食品饮水', '沙袋挡板', '抽水机泵', '发改储备物资', '民政救灾物资', '水务专用物资', '其他'] },
  ...
  facilities: {
    title: '场所设施',
    fields: [
      { key: 'name', label: '设施名称', required: true, placeholder: '如: XX应急避护场所' },
      { key: 'type', label: '类型', picker: ['应急避护场所', '物资储备库', '指挥中心', '医疗救护点', '临时安置点', '应急水源', '直升机停机坪', '其他'] },
  ...
  vehicles: {
    ...
    fields: [
      ...
      { key: 'type', label: '车辆类型', required: true, picker: ['消防车', '抢险车', '运输车', '指挥车', '救护车', '排涝车', '无人机', '冲锋舟', '其他'] },
